...
export class Backend implements backendInterface {
    ...
    async createGreeting(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createGreeting(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async listAllGreetings(): Promise<Array<[string, Greeting]>> {
        if (this.processError) {
            try {
                const result = await this.actor.listAllGreetings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
